...
Model* Mdb::getModel(int No) const
{
    return mModels[No];
}

Model* Mdb::getModel(std::string name) const
{
...
Job* Mdb::getJob(int No) const
{
    return mJobs[No];
}

Job* Mdb::getJob(std::string name) const
{
...
Model* Mdb::createModel(std::string myName)
{
...
Job* Mdb::createJob(std::string name, Model* model)
{
